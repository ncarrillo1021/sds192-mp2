...
```{r}
total_cont_graph <- ggplot(final_table, aes(x = cmte_party_affiliation, y = total_cont)) +
  geom_bar( stat = "identity")


num_commit_graph <- ggplot(final_table, aes(x = cmte_party_affiliation, y = num_committees)) +
  geom_bar( stat = "identity")
